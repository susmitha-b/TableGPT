...
def main():
    ...
    parser.add_argument('--tokenized_gold_train_path', default='data/', type=str, required=True,
                        help='Training set target tokenized Corpus storage location')
    ...
    parser.add_argument('--tokenized_dev_path', default='data/', type=str, required=False,
                        help='Validation set tokenized Corpus storage location')
    ...
    parser.add_argument('--start_eval_epoch', default=1, type=int, required=False, help='Start counting the number of rounds of validating the BLEU value of the set')
    ...
    parser.add_argument('--shuffle', action='store_true', help='Whether in each epoch dislocate batch order')
